...
(function () {
  ...
  /**
                                                                                        ...
                                                                                        */var
  Card = function () {
    function Card(str) {(0, _classCallCheck3.default)(this, Card);
    ...
    }(0, _createClass3.default)(Card, [{ key: 'toString', value: function toString()
  ...
  /**
                              ...
                              */var
  Hand = function () {
    function Hand(cards, name, game, canDisqualify) {(0, _classCallCheck3.default)(this, Hand);
      this.cardPool = [];
      this.cards = [];
      this.suits = {};
      this.values = [];
    ...
    /**
       ...
       * @return {Number}
       */(0, _createClass3.default)(Hand, [{ key: 'compare', value: function compare(
      a) {
        if (this.rank < a.rank) {
          return 1;
      ...
      /**
         ...
         * @return {Boolean}
         */ }, { key: 'loseTo', value: function loseTo(
      hand) {
      ...
      /**
         ...
         */ }, { key: 'getNumCardsByRank', value: function getNumCardsByRank(
      val) {
      ...
      /**
         ...
         */ }, { key: 'getCardsForFlush', value: function getCardsForFlush(
      suit, setRanks) {
      ...
      /**
         ...
         */ }, { key: 'resetWildCards', value: function resetWildCards()
      {
        for (var i = 0; i < this.wilds.length; i++) {
          this.wilds[i].rank = -1;
      ...
      /**
         ...
         */ }, { key: 'nextHighest', value: function nextHighest()
      {
        var picks;
        var excluding = [];
      ...
      /**
         ...
         * @return {Boolean}
         */ }, { key: 'qualifiesHigh', value: function qualifiesHigh()
      {
      ...
      /**
         ...
         */ }], [{ key: 'winners', value: function winners(
      hands) {
      ...
      /**
         ...
         */ }, { key: 'solve', value: function solve(
      cards, game, canDisqualify) {
        game = game || 'standard';
      ...
      /**
         ...
         */ }, { key: 'stripWilds', value: function stripWilds(
      cards, game) {
  ...
  StraightFlush = function (_Hand) {(0, _inherits3.default)(StraightFlush, _Hand);
    function StraightFlush(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, StraightFlush);return (0, _possibleConstructorReturn3.default)(this, (StraightFlush.__proto__ || (0, _getPrototypeOf2.default)(StraightFlush)).call(this,
      cards, 'Straight Flush', game, canDisqualify));
    }(0, _createClass3.default)(StraightFlush, [{ key: 'solve', value: function solve()
      ...
      } }]);return StraightFlush;}(Hand);var


  RoyalFlush = function (_StraightFlush) {(0, _inherits3.default)(RoyalFlush, _StraightFlush);
    function RoyalFlush(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, RoyalFlush);return (0, _possibleConstructorReturn3.default)(this, (RoyalFlush.__proto__ || (0, _getPrototypeOf2.default)(RoyalFlush)).call(this,
      cards, game, canDisqualify));
    }(0, _createClass3.default)(RoyalFlush, [{ key: 'solve', value: function solve()

      {
        this.resetWildCards();
        var result = (0, _get3.default)(RoyalFlush.prototype.__proto__ || (0, _getPrototypeOf2.default)(RoyalFlush.prototype), 'solve', this).call(this);
        return result && this.descr === 'Royal Flush';
      } }]);return RoyalFlush;}(StraightFlush);var


  NaturalRoyalFlush = function (_RoyalFlush) {(0, _inherits3.default)(NaturalRoyalFlush, _RoyalFlush);
    function NaturalRoyalFlush(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, NaturalRoyalFlush);return (0, _possibleConstructorReturn3.default)(this, (NaturalRoyalFlush.__proto__ || (0, _getPrototypeOf2.default)(NaturalRoyalFlush)).call(this,
      cards, game, canDisqualify));
    }(0, _createClass3.default)(NaturalRoyalFlush, [{ key: 'solve', value: function solve()

      {
        var i = 0;
        this.resetWildCards();
        var result = (0, _get3.default)(NaturalRoyalFlush.prototype.__proto__ || (0, _getPrototypeOf2.default)(NaturalRoyalFlush.prototype), 'solve', this).call(this);
        ...
        return result;
      } }]);return NaturalRoyalFlush;}(RoyalFlush);var


  WildRoyalFlush = function (_RoyalFlush2) {(0, _inherits3.default)(WildRoyalFlush, _RoyalFlush2);
    function WildRoyalFlush(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, WildRoyalFlush);return (0, _possibleConstructorReturn3.default)(this, (WildRoyalFlush.__proto__ || (0, _getPrototypeOf2.default)(WildRoyalFlush)).call(this,
      cards, game, canDisqualify));
    }(0, _createClass3.default)(WildRoyalFlush, [{ key: 'solve', value: function solve()

      {
        var i = 0;
        this.resetWildCards();
        var result = (0, _get3.default)(WildRoyalFlush.prototype.__proto__ || (0, _getPrototypeOf2.default)(WildRoyalFlush.prototype), 'solve', this).call(this);
        if (result && this.cards) {
          for (i = 0; i < this.game.sfQualify && i < this.cards.length; i++) {
            if (this.cards[i].value === this.game.wildValue) {
              this.descr = 'Wild Royal Flush';
        ...
        return result;
      } }]);return WildRoyalFlush;}(RoyalFlush);var


  FiveOfAKind = function (_Hand2) {(0, _inherits3.default)(FiveOfAKind, _Hand2);
    function FiveOfAKind(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, FiveOfAKind);return (0, _possibleConstructorReturn3.default)(this, (FiveOfAKind.__proto__ || (0, _getPrototypeOf2.default)(FiveOfAKind)).call(this,
      cards, 'Five of a Kind', game, canDisqualify));
    }(0, _createClass3.default)(FiveOfAKind, [{ key: 'solve', value: function solve()
      ...
      } }]);return FiveOfAKind;}(Hand);var


  FourOfAKindPairPlus = function (_Hand3) {(0, _inherits3.default)(FourOfAKindPairPlus, _Hand3);
    function FourOfAKindPairPlus(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, FourOfAKindPairPlus);return (0, _possibleConstructorReturn3.default)(this, (FourOfAKindPairPlus.__proto__ || (0, _getPrototypeOf2.default)(FourOfAKindPairPlus)).call(this,
      cards, 'Four of a Kind with Pair or Better', game, canDisqualify));
    }(0, _createClass3.default)(FourOfAKindPairPlus, [{ key: 'solve', value: function solve()
      ...
      } }]);return FourOfAKindPairPlus;}(Hand);var


  FourOfAKind = function (_Hand4) {(0, _inherits3.default)(FourOfAKind, _Hand4);
    function FourOfAKind(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, FourOfAKind);return (0, _possibleConstructorReturn3.default)(this, (FourOfAKind.__proto__ || (0, _getPrototypeOf2.default)(FourOfAKind)).call(this,
      cards, 'Four of a Kind', game, canDisqualify));
    }(0, _createClass3.default)(FourOfAKind, [{ key: 'solve', value: function solve()
      ...
      } }]);return FourOfAKind;}(Hand);var


  FourWilds = function (_Hand5) {(0, _inherits3.default)(FourWilds, _Hand5);
    function FourWilds(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, FourWilds);return (0, _possibleConstructorReturn3.default)(this, (FourWilds.__proto__ || (0, _getPrototypeOf2.default)(FourWilds)).call(this,
      cards, 'Four Wild Cards', game, canDisqualify));
    }(0, _createClass3.default)(FourWilds, [{ key: 'solve', value: function solve()

      {
        ...
        return this.cards.length >= 4;
      } }]);return FourWilds;}(Hand);var


  ThreeOfAKindTwoPair = function (_Hand6) {(0, _inherits3.default)(ThreeOfAKindTwoPair, _Hand6);
    function ThreeOfAKindTwoPair(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, ThreeOfAKindTwoPair);return (0, _possibleConstructorReturn3.default)(this, (ThreeOfAKindTwoPair.__proto__ || (0, _getPrototypeOf2.default)(ThreeOfAKindTwoPair)).call(this,
      cards, 'Three of a Kind with Two Pair', game, canDisqualify));
    }(0, _createClass3.default)(ThreeOfAKindTwoPair, [{ key: 'solve', value: function solve()
      ...
      } }]);return ThreeOfAKindTwoPair;}(Hand);var


  FullHouse = function (_Hand7) {(0, _inherits3.default)(FullHouse, _Hand7);
    function FullHouse(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, FullHouse);return (0, _possibleConstructorReturn3.default)(this, (FullHouse.__proto__ || (0, _getPrototypeOf2.default)(FullHouse)).call(this,
      cards, 'Full House', game, canDisqualify));
    }(0, _createClass3.default)(FullHouse, [{ key: 'solve', value: function solve()

      {
        ...
        return this.cards.length >= 5;
      } }]);return FullHouse;}(Hand);var


  Flush = function (_Hand8) {(0, _inherits3.default)(Flush, _Hand8);
    function Flush(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, Flush);return (0, _possibleConstructorReturn3.default)(this, (Flush.__proto__ || (0, _getPrototypeOf2.default)(Flush)).call(this,
      cards, 'Flush', game, canDisqualify));
    }(0, _createClass3.default)(Flush, [{ key: 'solve', value: function solve()

      {
        ...
        return this.cards.length >= this.game.sfQualify;
      } }]);return Flush;}(Hand);var


  Straight = function (_Hand9) {(0, _inherits3.default)(Straight, _Hand9);
    function Straight(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, Straight);return (0, _possibleConstructorReturn3.default)(this, (Straight.__proto__ || (0, _getPrototypeOf2.default)(Straight)).call(this,
      cards, 'Straight', game, canDisqualify));
    }(0, _createClass3.default)(Straight, [{ key: 'solve', value: function solve()
      ...
      /**
         ...
         */ }, { key: 'getGaps', value: function getGaps(
      checkHandLength) {
        ...
        return gapCards;
      } }, { key: 'getWheel', value: function getWheel()

      {
        ...
        return wheelCards;
      } }]);return Straight;}(Hand);var


  TwoThreeOfAKind = function (_Hand10) {(0, _inherits3.default)(TwoThreeOfAKind, _Hand10);
    function TwoThreeOfAKind(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, TwoThreeOfAKind);return (0, _possibleConstructorReturn3.default)(this, (TwoThreeOfAKind.__proto__ || (0, _getPrototypeOf2.default)(TwoThreeOfAKind)).call(this,
      cards, 'Two Three Of a Kind', game, canDisqualify));
    }(0, _createClass3.default)(TwoThreeOfAKind, [{ key: 'solve', value: function solve()

      {
        ...
        return this.cards.length >= 6;
      } }]);return TwoThreeOfAKind;}(Hand);var


  ThreeOfAKind = function (_Hand11) {(0, _inherits3.default)(ThreeOfAKind, _Hand11);
    function ThreeOfAKind(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, ThreeOfAKind);return (0, _possibleConstructorReturn3.default)(this, (ThreeOfAKind.__proto__ || (0, _getPrototypeOf2.default)(ThreeOfAKind)).call(this,
      cards, 'Three of a Kind', game, canDisqualify));
    }(0, _createClass3.default)(ThreeOfAKind, [{ key: 'solve', value: function solve()
      ...
      } }]);return ThreeOfAKind;}(Hand);var


  ThreePair = function (_Hand12) {(0, _inherits3.default)(ThreePair, _Hand12);
    function ThreePair(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, ThreePair);return (0, _possibleConstructorReturn3.default)(this, (ThreePair.__proto__ || (0, _getPrototypeOf2.default)(ThreePair)).call(this,
      cards, 'Three Pair', game, canDisqualify));
    }(0, _createClass3.default)(ThreePair, [{ key: 'solve', value: function solve()

      {
        ...
        return this.cards.length >= 6;
      } }]);return ThreePair;}(Hand);var


  TwoPair = function (_Hand13) {(0, _inherits3.default)(TwoPair, _Hand13);
    function TwoPair(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, TwoPair);return (0, _possibleConstructorReturn3.default)(this, (TwoPair.__proto__ || (0, _getPrototypeOf2.default)(TwoPair)).call(this,
      cards, 'Two Pair', game, canDisqualify));
    }(0, _createClass3.default)(TwoPair, [{ key: 'solve', value: function solve()

      {
        ...
        return this.cards.length >= 4;
      } }]);return TwoPair;}(Hand);var


  OnePair = function (_Hand14) {(0, _inherits3.default)(OnePair, _Hand14);
    function OnePair(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, OnePair);return (0, _possibleConstructorReturn3.default)(this, (OnePair.__proto__ || (0, _getPrototypeOf2.default)(OnePair)).call(this,
      cards, 'Pair', game, canDisqualify));
    }(0, _createClass3.default)(OnePair, [{ key: 'solve', value: function solve()
      ...
      } }]);return OnePair;}(Hand);var


  HighCard = function (_Hand15) {(0, _inherits3.default)(HighCard, _Hand15);
    function HighCard(cards, game, canDisqualify) {(0, _classCallCheck3.default)(this, HighCard);return (0, _possibleConstructorReturn3.default)(this, (HighCard.__proto__ || (0, _getPrototypeOf2.default)(HighCard)).call(this,
      cards, 'High Card', game, canDisqualify));
    }(0, _createClass3.default)(HighCard, [{ key: 'solve', value: function solve()
  ...
  /*
                                      ...
                                      */var
  PaiGowPokerHelper = function () {
    /*
                                    * Constructor class.
                                    * @param {Hand} hand Solved hand against Game 'paigowpokerfull'.
                                    */
    function PaiGowPokerHelper(hand) {(0, _classCallCheck3.default)(this, PaiGowPokerHelper);
      this.baseHand = null;
      this.hiHand = null;
      this.loHand = null;
      this.game = null;
    ...
    /*
       ...
       */(0, _createClass3.default)(PaiGowPokerHelper, [{ key: 'splitHouseWay', value: function splitHouseWay()
      {
        var hiCards, loCards;
      ...
      /*
         ...
         */ }, { key: 'getSFData', value: function getSFData(
      cards) {
      ...
      /*
         ...
         * @return {Boolean}
         */ }, { key: 'qualifiesValid', value: function qualifiesValid()
      {
      ...
      /*
         ...
         */ }, { key: 'setHands', value: function setHands(
      hiHand, loHand) {
        var fullHand = [];
  ...
  /**
                                    ...
                                    */var
  Game =
  function Game(descr) {(0, _classCallCheck3.default)(this, Game);
    this.descr = descr;
    this.cardsInHand = 0;
    this.handValues = [];
    this.wildValue = null;
